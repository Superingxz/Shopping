...
import com.dl7.shopping.module.activity.home.combo.baseview.ComboOrderView;
import com.dl7.shopping.module.activity.home.combo.presenter.ComboOrderPresenter;
import com.dl7.shopping.module.activity.pay.DefeatedActivity;
import com.dl7.shopping.module.activity.pay.SuccessActivity;
...
public class ComboOrderActivity extends BaseActivity<ComboOrderPresenter> implements ComboOrderView {
    ...
    TextView title;
    @BindView(R.id.tv_combo_order_num)
    TextView num;
    @BindView(R.id.tv_combo_order_enable)
    TextView tvEnable;
    @BindView(R.id.tv_combo_order_specification)
    TextView tvSpecification;
    @BindView(R.id.tv_combo_order_money)
    TextView money;
    @BindView(R.id.tv_combo_order_name)
    TextView tvName;
    @BindView(R.id.tv_combo_order_phone)
    TextView phone;
    @BindView(R.id.tv_combo_order_store)
    TextView tvStroe;
    @BindView(R.id.tv_combo_order_address)
    TextView tvAddress;
    @BindView(R.id.ll_combo_order_detail)
    LinearLayout llComboOrderDetail;
    @BindView(R.id.tv_commit_order_combo)
    TextView commit;
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_combo_order;
    }
