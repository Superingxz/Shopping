package com.dl7.shopping.widget;
...
public class ImageCycleView extends LinearLayout {
    ...
    private void init(Context context){
        ...
        LayoutInflater.from(context).inflate(R.layout.recommend_viewpager, this);
...
//		mImageDescList=imageDesList;
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(R.mipmap.lunbo_dot);
            } else {
                mImageViews[i].setBackgroundResource(R.mipmap.lunbo_dot_opacity);
            }
...
//		imageName.setTextColor(getResources().getColor(R.color.blue));
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            // 设置图片滚动指示器背
            mImageViews[index].setBackgroundResource(R.mipmap.lunbo_dot);
