...
public class MyCollectClassifyAdapter extends BaseAdapter{
    ...
    public MyCollectClassifyAdapter(int[] img,String[] title,String[] money,Context context) {
        this.img=img;
        this.title=title;
        this.money=money;
...
//            holder.shoppingcart.setTypeface(iconFont);
            holder.shoppingcart.setText("...");
            holder.shoppingcart.setTextColor(Color.parseColor("#1a1a1a"));
            holder.img.setImageResource(img[position]);
            holder.title.setText(title[position]);
            holder.money.setText(money[position]);
            holder.money.setTextColor(Color.parseColor("#1a1a1a"));
        }
